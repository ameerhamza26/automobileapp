...
.service('User', ['httpService', function(httpService) {
   ...
   this.verifyCustomer = function(key) {
        var config = httpService.Utils.getHeader();
        var url = httpService.Utils.buildUrl(new Array('api', 'VerifyCustomer',key));
...
.service('Appointment', ['httpService', function(httpService) {
    ...
    this.getServices = function(brancId) {
        var config = httpService.Utils.getHeader();
        var url = httpService.Utils.buildUrl(new Array('api', 'branch', brancId, 'services'));
        return httpService.$http.get(url, config);
    }

    this.disableHolidays = function() {
         var config = httpService.Utils.getHeader();
        var url = httpService.Utils.buildUrl(new Array('api', 'annualholidays'));
        return httpService.$http.get(url, config);
    }

    this.enableDays = function(id) {
         var config = httpService.Utils.getHeader();
        var url = httpService.Utils.buildUrl(new Array('api', 'branch', id, 'workingdays'));
        return httpService.$http.get(url, config);
    }
