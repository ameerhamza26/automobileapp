// app.controller('BookAppointmentArabicCtrl', function($scope, $state, $http, $ionicModal, CityBranchId, Appointment, ionicTimePicker, $stateParams, AppointmentDetail, $rootScope, localStorageService, $ionicLoading) {
